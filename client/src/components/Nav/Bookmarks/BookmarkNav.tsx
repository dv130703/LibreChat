          ...
          render={
            <Ariakit.MenuButton
              ...
              className={cn(
                ...
                'outline-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-blue-500/70 dark:focus-visible:ring-blue-400/70',
