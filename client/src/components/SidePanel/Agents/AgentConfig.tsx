...
export default function AgentConfig() {
  ...
  return (
    <div className="grid grid-cols-1 gap-5 pt-1 lg:grid-cols-[3fr_2fr]">
      {/* LEFT COLUMN — content authoring: identity, instructions, tools, skills */}
      <div className="flex flex-col gap-5">
        <AgentBuilderCard id="section-identity">
        ...
        <AgentBuilderCard id="section-instructions">
          <Instructions />
        </AgentBuilderCard>
      ...
      <div className="flex flex-col gap-5">
        <AgentBuilderCard id="section-configuration">
          <label className="mb-3 block text-[11px] font-medium uppercase tracking-wide text-text-secondary">
            {localize('com_ui_configuration')}
          </label>
        ...
        {contextEnabled && (
          <AgentBuilderCard id="section-file-context">
            <FileContext agent_id={agent_id} files={contextFiles} />
          </AgentBuilderCard>
        )}

        <AgentBuilderCard id="section-support-contact">
          <label className="mb-3 block text-[11px] font-medium uppercase tracking-wide text-text-secondary">
