...
function TranscriptHeader({
  ...
  return (
    <div className="p-3">
      ...
      <div className="animate-fade-in rounded-xl border border-border-medium bg-surface-primary p-4 shadow-sm">
          ...
          <div className="flex h-full items-center gap-px">
            {displayPeaks.map((amplitude, index) => {
              ...
              const isHoverPreview =
                !isPlayed && hoverRatio != null && barRatio <= hoverRatio && barRatio > playedRatio;
              return (
                <div
                  key={index}
                  className={cn(
        ...
        <div className="mt-3 grid grid-cols-[1fr_auto_1fr] items-center gap-2">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <button
              ...
              className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-blue-500 text-white transition-colors hover:bg-blue-600 dark:bg-blue-400 dark:hover:bg-blue-500"
            >
              {isPlaying ? (
            ...
            <button
              type="button"
              onClick={() => skipBy(SKIP_SECONDS)}
              aria-label={localize('com_ui_transcript_skip_forward', { seconds: SKIP_SECONDS })}
              className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text-text-secondary transition-colors hover:bg-surface-hover hover:text-text-primary"
            >
          ...
          <div className="flex items-center gap-2 justify-self-end">
            ...
            <button
              ...
              aria-label={localize(isMuted ? 'com_ui_transcript_unmute' : 'com_ui_transcript_mute')}
