    ...
    <TooltipAnchor
      ...
      render={
        <a
          ...
          className="flex h-9 w-9 items-center justify-center rounded-lg transition-colors duration-150 hover:bg-surface-hover active:bg-surface-active-alt"
          onClick={handleClick}
        >
    ...
    <TooltipAnchor
      ...
      render={
        <Button
          ...
          className={cn(
            'relative h-9 w-9 rounded-lg transition-colors duration-150',
            isActive
              ? 'bg-surface-active-alt text-text-primary shadow-sm'
              : 'text-text-secondary hover:bg-surface-hover hover:text-text-primary active:bg-surface-active-alt',
          )}
          onClick={handleClick}
        >
          <span
            aria-hidden="true"
            className={cn(
              'absolute left-0 top-1/2 h-4 w-0.5 -translate-y-1/2 rounded-full bg-text-primary transition-opacity duration-150',
      ...
      <TooltipAnchor
        ...
        render={
          <Button
            ...
            className="h-9 w-9 rounded-lg text-text-secondary transition-colors duration-150 hover:bg-surface-hover hover:text-text-primary active:bg-surface-active-alt"
            onClick={toggleClick}
          >
            <Sidebar
              aria-hidden="true"
