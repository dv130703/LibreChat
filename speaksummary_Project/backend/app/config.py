...
class Settings(BaseSettings):
    ...
    # Onset starts a speech region, offset ends one (hysteresis, so a region
    # survives dips that would never have started it).
    ...
    # borderline for review rather than trusted - see services/vad_tiers.py.
    # Setting these equal to the pair above empties the borderline tier, which
    # is how a deployment opts out of the second pass.
