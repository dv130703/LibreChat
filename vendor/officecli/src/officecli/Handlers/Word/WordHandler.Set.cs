    ...
    private bool ApplyParagraphLevelProperty(ParagraphProperties pProps, string key, string? value, List<string>? warnings = null)
    {
        ...
        switch (key.ToLowerInvariant())
        {
            ...
            case "firstlineindent":
                ...
                indent.FirstLine = SpacingConverter.ParseWordSpacingSigned(value, "firstLineIndent").ToString();
                indent.Hanging = null;
                return true;
            case "leftindent" or "indentleft" or "indent":
                ...
                indentL.Left = SpacingConverter.ParseWordSpacingSigned(value, "leftIndent").ToString();
                return true;
            case "rightindent" or "indentright":
                var indentR = pProps.Indentation ?? (pProps.Indentation = new Indentation());
                // BUG-DUMP-NEGIND: signed.
                indentR.Right = SpacingConverter.ParseWordSpacingSigned(value, "rightIndent").ToString();
                return true;
            case "hangingindent" or "hanging":
                var indentH = pProps.Indentation ?? (pProps.Indentation = new Indentation());
                indentH.Hanging = SpacingConverter.ParseWordSpacing(value, "hangingIndent").ToString();
